...
public class moveAround : MonoBehaviour {
    ...
    void Update () {
        if (Input.GetKey(KeyCode.W))
        {
            ...
            Camera.transform.RotateAround(transform.position, new Vector3(1.0f, 0.0f, 0.0f), 0.2f);
        }
        ...
        if (Input.GetKey(KeyCode.A))
        {
            ...
            Camera.transform.RotateAround(transform.position, new Vector3(0.0f, 1.0f, 0.0f), 0.2f);
